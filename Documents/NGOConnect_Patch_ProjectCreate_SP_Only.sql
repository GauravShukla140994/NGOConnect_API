-- ============================================================
-- NGOConnect: Recreate Project_Create + Project_Update SPs only
-- Use this if the main patch ran but the SPs weren't recreated.
--
-- HOW TO RUN IN MYSQL WORKBENCH:
--   1. Open this file in MySQL Workbench
--   2. Menu → Query → "Run SQL Script" (NOT the lightning bolt)
--      OR: select ALL text → Run (the lightning bolt runs statement by statement
--          which breaks multi-statement procedures)
--   3. Check the Output tab — should show 2 successful statements
-- ============================================================
