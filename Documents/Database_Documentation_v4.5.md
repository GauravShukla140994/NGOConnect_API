...
**v4.5 Additions — Super Admin Module (2026-07-11):**
...
| SP Name | Params | Type | Description |
|---|---|---|---|
| SuperAdmin_Org_GetList | p_StatusCode, p_PageNumber, p_PageSize | PAGED | Returns org rows: OrgId, OrgName, LogoUrl, StatusCode, StatusName, OrgTypeName, City, MemberCount, SubmittedAt, LastReason. p_StatusCode NULL = all statuses |
| SuperAdmin_Org_GetDetail | p_OrgId | READ | Full org detail: all list fields + About, Mission, Vision, FounderName, FounderEmail, FounderMobile, AddressLine, Landmark, City, State, Pincode, RegisteredAt |
