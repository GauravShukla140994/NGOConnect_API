...
-- ^ #47 is INVITE_TYPE, #48 is INVITE_STATUS — added v4.9
...
-- v4.9 UPDATED: auto-creates a session from project schedule if none exists,
...
-- ============================================================
-- v4.9: ORG MEMBER INVITATION STORED PROCEDURES
-- ============================================================
DELIMITER //
