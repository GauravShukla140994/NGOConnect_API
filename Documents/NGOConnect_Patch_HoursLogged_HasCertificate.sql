-- ============================================================
-- NGOConnect Patch: HoursLogged + HasCertificate on User Applications
-- Fixes: hours not showing on Impact screen completed projects
--        hours + certificate button missing on MyProjects screen completed tab
...
SELECT 'PATCH applied: User_GetImpactSummary RS2 + Application_GetByUser — added HoursLogged and HasCertificate' AS Result;
